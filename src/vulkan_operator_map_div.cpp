...
void vulkan_operator_map_div(float * inputs, int numInputs, float * outputs, float scalar, float * outTime)
{
	...
	auto program = vuh::Program<Specs, Params>(device, SHADERS_LOCATION "map_divide_scalar.spv");
